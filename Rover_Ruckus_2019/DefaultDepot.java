...
@Autonomous (name = "DefaultDepot")
public class DefaultDepot extends LinearOpMode {
...
*/
    ...
    public void detect() throws InterruptedException {
        ...
        do {
            pos = (cam.getPosition() >= 0.8 && cam.getPosition() < 0.85) ? 0.85 : 0.8;
            cam.setPosition(pos);
            TensorFlow.detect();
            cnt++;
...
*/
    ...
    private void AutonPath() throws InterruptedException {
        ...
        if (TensorFlow.left) {
            ...
            // telemetry.addData("iosytaeru", "siryhoirt");
            // telemetry.update();

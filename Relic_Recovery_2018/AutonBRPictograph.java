...
@Disabled
@Autonomous (name="AutonBRPictograph")
public class AutonBRPictograph extends LinearOpMode
{
    ...
    private void AutonPath (GyroCalculations gyroCalc) throws InterruptedException
    {
        ...
        //Forward
        start_angle = gyroCalc.currentAngle;
        enc_diff = drive_straight(12, start_angle, end_angle, gyroCalc);
        end_angle = gyroCalc.currentAngle;
        Forward(0,0);
        ...
        start_angle = gyroCalc.currentAngle;
        end_angle = gyroCalc.currentAngle;
        enc_diff = drive_straight(15, start_angle, end_angle, gyroCalc);
        end_angle = gyroCalc.currentAngle;
        Forward(0,0);
        ...
        //Move Back
        start_angle = gyroCalc.currentAngle;
        enc_diff = drive_straight(-2, start_angle, end_angle, gyroCalc);
        end_angle = gyroCalc.currentAngle;
        Forward(0,0);
    }

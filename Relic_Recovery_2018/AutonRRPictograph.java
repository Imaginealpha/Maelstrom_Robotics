...
@Disabled
@Autonomous (name="AutonRRPictograph")
public class AutonRRPictograph extends LinearOpMode
{
    ...
    private void AutonPath (GyroCalculations gyroCalc) throws InterruptedException
    {
        ...
        //Move to pictograph
        double start_angle = gyroCalc.currentAngle;
        middle_wheel.setPower(-0.5); Thread.sleep(150); middle_wheel.setPower(0); Thread.sleep(1000);
        double end_angle = gyroCalc.currentAngle;
        jewelArm.setPosition(0.7);
        Thread.sleep(1000);
        ...
        //Forward
        start_angle = gyroCalc.currentAngle;
        double enc_diff = drive_straight(9, start_angle, end_angle, gyroCalc);
        end_angle = gyroCalc.currentAngle;
        Forward(0,0);
        ...
        //Forward
        start_angle = gyroCalc.currentAngle;
        enc_diff = drive_straight(10, start_angle, end_angle, gyroCalc);
        end_angle = gyroCalc.currentAngle;
        Forward(0,0);
        ...
        telemetry.update();
        middle_wheel.setPower(-0.5); Thread.sleep(side_time); middle_wheel.setPower(0); Thread.sleep(1000);

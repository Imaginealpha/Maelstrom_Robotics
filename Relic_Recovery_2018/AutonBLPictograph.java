...
@Disabled
@Autonomous (name="AutonBLPictograph")
public class AutonBLPictograph extends LinearOpMode
{
    ...
    private void AutonPath (GyroCalculations gyroCalc) throws InterruptedException
    {
        ...
        //Forward
        start_angle = gyroCalc.currentAngle;
        double enc_diff = drive_straight(8.5, start_angle, end_angle, gyroCalc);
        end_angle = gyroCalc.currentAngle;
        Forward(0,0);
        ...
        //Forward
        start_angle = gyroCalc.currentAngle;
        enc_diff = drive_straight(16, start_angle, end_angle, gyroCalc);
        end_angle = gyroCalc.currentAngle;
        Forward(0,0);
